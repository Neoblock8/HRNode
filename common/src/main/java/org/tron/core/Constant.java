...
public class Constant {
  ...
  public static final byte ADD_PRE_FIX_BYTE_MAINNET = (byte) 0x28;   //41 + address
  public static final String ADD_PRE_FIX_STRING_MAINNET = "28";
  ...
  public static final long SUN_PER_ENERGY = 100; // 1 us = 100 SUN = 100 * 10^-6 WYZ
  ...
  public static final String NODE_NET_MAX_WYZ_PER_SECOND = "node.netMaxWyzPerSecond";
  ...
  public static final String COMMITTEE_ALLOW_WVM_TRANSFER_TRC10 = "committee.allowWvmTransferTrc10";

  public static final String COMMITTEE_ALLOW_WVM_CONSTANTINOPLE = "committee.allowWvmConstantinople";

  public static final String COMMITTEE_ALLOW_WVM_SOLIDITY059 = "committee.allowWvmSolidity059";
  ...
  public static final String WYZ_REFERENCE_BLOCK = "wyz.reference.block";

  public static final String WYZ_EXPIRATION_TIME_IN_MILLIS_SECONDS = "wyz.expiration.timeInMilliseconds";
  ...
  public static final String COMMITTEE_ALLOW_WVM_ISTANBUL = "committee"
      + ".allowWvmIstanbul";
  ...
  public static final String COMMITTEE_ALLOW_WVM_STAKE = "committee.allowWvmStake";

  public static final String COMMITTEE_ALLOW_WVM_ASSETISSUE = "committee.allowWvmAssetIssue";
