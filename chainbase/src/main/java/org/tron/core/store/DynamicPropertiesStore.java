...
@Slf4j(topic = "DB")
@Component
public class DynamicPropertiesStore extends HRNetworkStoreWithRevoking<BytesCapsule> {
  ...
  //This value is only allowed to be 0, 1, -1
  private static final byte[] ALLOW_WVM_TRANSFER_TRC10 = "ALLOW_WVM_TRANSFER_TRC10".getBytes();
  ...
  private static final byte[] ALLOW_SHIELDED_TRC20_TRANSACTION =
      "ALLOW_SHIELDED_TRC20_TRANSACTION"
          .getBytes();
  private static final byte[] ALLOW_WVM_ISTANBUL = "ALLOW_WVM_ISTANBUL".getBytes();
  private static final byte[] ALLOW_WVM_STAKE = "ALLOW_WVM_STAKE".getBytes();
  private static final byte[] ALLOW_WVM_ASSET_ISSUE = "ALLOW_WVM_ASSET_ISSUE".getBytes();
  private static final byte[] ALLOW_WVM_CONSTANTINOPLE = "ALLOW_WVM_CONSTANTINOPLE".getBytes();
  private static final byte[] ALLOW_WVM_SOLIDITY_059 = "ALLOW_WVM_SOLIDITY_059".getBytes();
  ...
  private static final byte[] BURN_WYZ_AMOUNT = "BURN_WYZ_AMOUNT".getBytes();
  ...
  private DynamicPropertiesStore(@Value("properties") String dbName) {
    ...
    try {
      ...
      this.saveWitnessPayPerBlock(2000000L);
    }
    ...
    try {
      ...
      this.saveCreateAccountFee(100_000L); // 0.1WYZ
    }
    ...
    try {
      this.getAllowWvmTransferTrc10();
    } catch (IllegalArgumentException e) {
      this.saveAllowWvmTransferTrc10(CommonParameter.getInstance()
          .getAllowWvmTransferTrc10());
    }

    try {
      this.getAllowWvmConstantinople();
    } catch (IllegalArgumentException e) {
      this.saveAllowWvmConstantinople(CommonParameter.getInstance()
          .getAllowWvmConstantinople());
    }

    try {
      this.getAllowWvmSolidity059();
    } catch (IllegalArgumentException e) {
      this.saveAllowWvmSolidity059(CommonParameter.getInstance()
          .getAllowWvmSolidity059());
    }
    ...
    try {
      this.getAllowWvmIstanbul();
    } catch (IllegalArgumentException e) {
      this.saveAllowWvmIstanbul(
          CommonParameter.getInstance().getAllowWvmIstanbul());
    }

    try {
      this.getAllowWvmStake();
    } catch (IllegalArgumentException e) {
      this.saveAllowWvmStake(
          CommonParameter.getInstance().getAllowWvmStake());
    }

    try {
      this.getAllowWvmAssetIssue();
    } catch (IllegalArgumentException e) {
      this.saveAllowWvmAssetIssue(
          CommonParameter.getInstance().getAllowWvmAssetIssue());
    }
  ...
  public void saveTotalStoragePool(long wyz) {
    this.put(TOTAL_STORAGE_POOL,
        new BytesCapsule(ByteArray.fromLong(wyz)));
  }
  ...
  public void saveTotalStorageTax(long wyz) {
  ...
  public void saveAllowWvmTransferTrc10(long value) {
    this.put(ALLOW_WVM_TRANSFER_TRC10,
        new BytesCapsule(ByteArray.fromLong(value)));
  }

  public long getAllowWvmTransferTrc10() {
    return Optional.ofNullable(getUnchecked(ALLOW_WVM_TRANSFER_TRC10))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found ALLOW_WVM_TRANSFER_TRC10"));
  }

  public void saveAllowWvmConstantinople(long value) {
    this.put(ALLOW_WVM_CONSTANTINOPLE,
        new BytesCapsule(ByteArray.fromLong(value)));
  }

  public long getAllowWvmConstantinople() {
    return Optional.ofNullable(getUnchecked(ALLOW_WVM_CONSTANTINOPLE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException("not found ALLOW_WVM_CONSTANTINOPLE"));
  }

  public void saveAllowWvmSolidity059(long value) {
    this.put(ALLOW_WVM_SOLIDITY_059,
        new BytesCapsule(ByteArray.fromLong(value)));
  }

  public long getAllowWvmSolidity059() {
    return Optional.ofNullable(getUnchecked(ALLOW_WVM_SOLIDITY_059))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(() -> new IllegalArgumentException("not found ALLOW_WVM_SOLIDITY_059"));
  }
  ...
  public void updateDynamicStoreByConfig() {
    if (CommonParameter.getInstance()
        .getAllowWvmConstantinople() != 0) {
      saveAllowWvmConstantinople(CommonParameter.getInstance()
          .getAllowWvmConstantinople());
  ...
  public void saveAllowWvmIstanbul(long allowWVMIstanbul) {
    this.put(DynamicPropertiesStore.ALLOW_WVM_ISTANBUL,
        new BytesCapsule(ByteArray.fromLong(allowWVMIstanbul)));
  }

  public long getAllowWvmIstanbul() {
    String msg = "not found ALLOW_WVM_ISTANBUL";
    return Optional.ofNullable(getUnchecked(ALLOW_WVM_ISTANBUL))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(msg));
  ...
  public void saveAllowWvmStake(long allowWvmStake) {
    this.put(DynamicPropertiesStore.ALLOW_WVM_STAKE,
        new BytesCapsule(ByteArray.fromLong(allowWvmStake)));
  }

  public void saveAllowWvmAssetIssue(long allowWvmAssetIssue) {
    this.put(DynamicPropertiesStore.ALLOW_WVM_ASSET_ISSUE,
        new BytesCapsule(ByteArray.fromLong(allowWvmAssetIssue)));
  }

  public long getAllowWvmStake() {
    String msg = "not found ALLOW_WVM_STAKE";
    return Optional.ofNullable(getUnchecked(ALLOW_WVM_STAKE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(msg));
  ...
  public long getAllowWvmAssetIssue() {
    String msg = "not found ALLOW_WVM_ASSETISSUE";
    return Optional.ofNullable(getUnchecked(ALLOW_WVM_ASSET_ISSUE))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
            () -> new IllegalArgumentException(msg));
  ...
  public long getBurnWyzAmount() {
    return Optional.ofNullable(getUnchecked(BURN_WYZ_AMOUNT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(() -> new IllegalArgumentException("not found BURN_WYZ_AMOUNT"));
  }

  public void burnWyz(long amount) {
    if (amount <= 0) {
      return;
    }
    amount += getBurnWyzAmount();
    saveBurnWyz(amount);
  }

  private void saveBurnWyz(long amount) {
    this.put(BURN_WYZ_AMOUNT, new BytesCapsule(ByteArray.fromLong(amount)));
  }
