...
```bash
git clone https://github.com/Neoblock8/tron-chain-w001.git
...
* If you'd rather not use Git, [Download the ZIP](https://github.com/Neoblock8/tron-chain-w001.git/archive/develop.zip)

## Including HRNETWORK as dependency
...
...
<dependency>
    <groupId>com.github.Neoblock8</groupId>
    <artifactId>tron-chain-w001</artifactId>
...
* Building using [IntelliJ IDEA](https://www.jetbrains.com/idea/) (community version is enough):
  ...
  **Please run ./gradlew build once to build the protocol files**
  ...
  1. Start IntelliJ. Select `File` -> `Open`, then locate to the tron-chain-w001 folder which you have git cloned to your local drive. Then click `Open` button on the right bottom.
