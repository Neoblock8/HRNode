...
public class EnergyWhenRequireStyleTest {
  ...
  public void throwTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = WvmTestUtils.parseAbi("testThrow()", null);
    result = WvmTestUtils
  ...
  public void requireTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = WvmTestUtils.parseAbi("testRequire()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void thisFunctionViaMessageCallTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = WvmTestUtils.parseAbi("testThisFunctionViaMessageCall()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void thatFunctionViaMessageCallTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = WvmTestUtils.parseAbi("testThatFunctionViaMessageCall()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void newContractTest1()
    ...
    /* ====================================================================== */
    byte[] triggerData = WvmTestUtils.parseAbi("testNewContract()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  // }
  //
  // contract testReceiveWyzWithoutPayableContract {
  //
  //   constructor() {}
  //
  ...
  @Test
  public void receiveWyzWithoutPayableTest()
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException,
      VMIllegalException {
    ...
    result = WvmTestUtils
        .deployContractAndReturnWvmTestResult(contractName, address, ABI, code, 0, feeLimit,
            consumeUserResourcePercent, libraryAddressPair, dbManager, null);
    byte[] contractAddress = result.getContractAddress();
    ...
    Assert.assertEquals(dbManager.getAccountStore().get(address).getBalance(),
        totalBalance - (expectEnergyUsageTotal + expectEnergyUsageTotal2) * 100);
    /* ====================================================================== */
    byte[] triggerData = WvmTestUtils.parseAbi("testFallback()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
  ...
  public void revertTest()
    ...
    /* ====================================================================== */
    byte[] triggerData = WvmTestUtils.parseAbi("testRevert()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
