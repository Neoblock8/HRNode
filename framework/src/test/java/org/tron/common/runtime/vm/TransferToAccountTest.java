...
public class TransferToAccountTest {
  ...
  private static final int WYZ_NUM = 10;
  ...
  private long createAsset(String tokenName) {
    ...
    chainBaseManager.getDynamicPropertiesStore().saveAllowWvmTransferTrc10(1);
    chainBaseManager.getDynamicPropertiesStore().saveAllowWvmConstantinople(1);
    chainBaseManager.getDynamicPropertiesStore().saveAllowWvmSolidity059(1);
  ...
  public void TransferTokenTest()
    ...
    runtime = WvmTestUtils.processTransactionAndReturnRuntime(transaction, dbManager, null);
    ...
    //5. Test transfer Wyz with exsit account
    ...
    //6. Test  transfer Wyz with non-exsit account
    selectorStr = "transferTo(address,uint256)";
