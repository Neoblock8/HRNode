...
import static org.tron.common.runtime.WvmTestUtils.generateDeploySmartContractAndGetTransaction;
import static org.tron.common.runtime.WvmTestUtils.generateTriggerSmartContractAndGetTransaction;
...
public class RuntimeImplTest {
  ...
  public void init() {
    ...
    dbManager.getDynamicPropertiesStore().saveTotalEnergyWeight(5_000_000_000L); // unit is wyz
  ...
  public void getCreatorEnergyLimit2Test() throws ContractValidateException, ContractExeException {
    ...
    Transaction wyz = generateDeploySmartContractAndGetTransaction(contractName, creatorAddress,
        ABI,
        code, value, feeLimit, consumeUserResourcePercent, libraryAddressPair);

    RuntimeImpl runtimeImpl = new RuntimeImpl();
    runtimeImpl.execute(
        new TransactionContext(null, new TransactionCapsule(wyz),
  ...
  public void getCallerAndCreatorEnergyLimit2With0PercentTest()
    ...
    WVMTestResult result = WvmTestUtils
        .deployContractWithCreatorEnergyLimitAndReturnWvmTestResult(contractName, creatorAddress,
            ABI, code, value,
            feeLimit, consumeUserResourcePercent, libraryAddressPair, dbManager, null,
            creatorEnergyLimit);

    byte[] contractAddress = result.getContractAddress();
    byte[] triggerData = WvmTestUtils.parseAbi("testNotConstant()", null);
    Transaction wyz = generateTriggerSmartContractAndGetTransaction(callerAddress, contractAddress,
    ...
    TriggerSmartContract contract = ContractCapsule.getTriggerContractFromTransaction(wyz);
