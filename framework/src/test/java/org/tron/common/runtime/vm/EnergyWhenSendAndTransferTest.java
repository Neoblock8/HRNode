...
public class EnergyWhenSendAndTransferTest {
  ...
  public void callValueTest()
    ...
    WVMTestResult result = deployCallValueTestContract(value, feeLimit, consumeUserResourcePercent);
    ...
    /* =================================== CALL simpleCall() =================================== */
    byte[] triggerData = WvmTestUtils.parseAbi("simpleCall()", null);
    result = WvmTestUtils
    ...
    /* =================================== CALL complexCall() =================================== */
    triggerData = WvmTestUtils.parseAbi("complexCall()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void sendTest()
    ...
    long consumeUserResourcePercent = 100;
    byte[] address = Hex.decode(OWNER_ADDRESS);
    WVMTestResult result = deploySendAndTransferTestContract(value, feeLimit,
    ...
    /* =================================== CALL doSend() =================================== */
    byte[] triggerData = WvmTestUtils.parseAbi("doSend()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void transferTest()
    ...
    /* =================================== CALL doSend() =================================== */
    byte[] triggerData = WvmTestUtils.parseAbi("doTransfer()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public WVMTestResult deployCallValueTestContract(long value, long feeLimit,
  ...
  public WVMTestResult deploySendAndTransferTestContract(long value, long feeLimit,
      long consumeUserResourcePercent)
      throws ContractExeException, ReceiptCheckErrException, ContractValidateException,
      VMIllegalException {
