...
public class RuntimeTransferComplexTest {
   ...
   */
  @Test
  public void TransferWyzToContractAccountWhenDeployAContract()
    ...
    Transaction wyz = WvmTestUtils
        .generateDeploySmartContractAndGetTransaction(contractName, address, ABI, code, value, fee,
            consumeUserResourcePercent, null);
    byte[] contractAddress = WalletUtil.generateContractAddress(wyz);
    runtime = WvmTestUtils.processTransactionAndReturnRuntime(wyz, deposit, null);
  ...
  @Test
  public void TransferWyzToContractAccountFailIfNotPayable()
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
   ...
   */
  @Test
  public void TransferWyzToContractAccountWhenTriggerAContract()
      throws ContractExeException, ReceiptCheckErrException,
      ContractValidateException, VMIllegalException {
    ...
    byte[] contractAddress = WvmTestUtils
    ...
    byte[] triggerData = WvmTestUtils.parseAbi(selectorStr, params);

    long triggerCallValue = 100;

    Transaction transaction = WvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(address, contractAddress, triggerData,
            triggerCallValue, feeLimit);
    runtime = WvmTestUtils.processTransactionAndReturnRuntime(transaction, deposit, null);
    Assert.assertNull(runtime.getRuntimeError());
  ...
  public void TransferCallValueTestWhenUsingCallAndCreate()
    ...
    String params1 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData1 = WvmTestUtils.parseAbi(selectorStr1, params1);

    Transaction transaction1 = WvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData1, triggerCallValue, feeLimit);
    runtime = WvmTestUtils.processTransactionAndReturnRuntime(transaction1, deposit, null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    String params2 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData2 = WvmTestUtils.parseAbi(selectorStr2, params2);

    Transaction transaction2 = WvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData2, triggerCallValue, feeLimit);
    runtime = WvmTestUtils.processTransactionAndReturnRuntime(transaction2, deposit, null);
    ...
    String params3 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData3 = WvmTestUtils.parseAbi(selectorStr3, params3);

    Transaction transaction3 = WvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData3, triggerCallValue, feeLimit);
    runtime = WvmTestUtils.processTransactionAndReturnRuntime(transaction3, deposit, null);
    ...
    String params4 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData4 = WvmTestUtils.parseAbi(selectorStr4, params4);

    Transaction transaction4 = WvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData4, triggerCallValue, feeLimit);
    runtime = WvmTestUtils.processTransactionAndReturnRuntime(transaction4, deposit, null);
    ...
    String params5 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData5 = WvmTestUtils.parseAbi(selectorStr5, params5);

    Transaction transaction5 = WvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData5, triggerCallValue, feeLimit);
    runtime = WvmTestUtils.processTransactionAndReturnRuntime(transaction5, deposit, null);
    ...
    String params6 =
        "000000000000000000000000548794500882809695a8a687866e76d4271a1abc"; //TRANSFER_TO
    byte[] triggerData6 = WvmTestUtils.parseAbi(selectorStr6, params6);

    Transaction transaction6 = WvmTestUtils
        .generateTriggerSmartContractAndGetTransaction(msgSenderAddress, callerAddress,
            triggerData6, triggerCallValue, feeLimit);
    runtime = WvmTestUtils.processTransactionAndReturnRuntime(transaction6, deposit, null);
