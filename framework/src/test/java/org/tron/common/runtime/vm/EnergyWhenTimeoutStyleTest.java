...
public class EnergyWhenTimeoutStyleTest {
  ...
  public void endlessLoopTest()
    ...
    WVMTestResult result = deployEndlessLoopContract(value, feeLimit,
    ...
    byte[] triggerData = WvmTestUtils.parseAbi("setVote(uint256)", params);
  ...
  public WVMTestResult deployEndlessLoopContract(long value, long feeLimit,
    ...
    return WvmTestUtils
        .deployContractAndReturnWvmTestResult(contractName, address, ABI, code,
            value,
