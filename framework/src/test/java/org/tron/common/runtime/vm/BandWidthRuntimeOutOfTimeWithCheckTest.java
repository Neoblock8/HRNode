...
public class BandWidthRuntimeOutOfTimeWithCheckTest {
  ...
  private String wyz2ContractAddress = "TPMBUANrTwwQAPwShn7ZZjTJz1f3F8jknj";
  ...
  public void testSuccess() {
    try {
      ...
      TriggerSmartContract triggerContract = WvmTestUtils.createTriggerContract(contractAddress,
      ...
      TransactionCapsule wyzCap = new TransactionCapsule(transaction);
      wyzCap.setResultCode(contractResult.OUT_OF_ENERGY);
      TransactionTrace trace = new TransactionTrace(wyzCap, StoreFactory.getInstance(),
          new RuntimeImpl());
      dbManager.consumeBandwidth(wyzCap, trace);
  ...
  private byte[] createContract()
    ...
    CreateSmartContract smartContract = WvmTestUtils.createSmartContract(
