...
public class EnergyWhenAssertStyleTest {
  ...
  public void outOfIndexTest()
    ...
    byte[] triggerData = WvmTestUtils.parseAbi("testOutOfIndex()", null);
    result = WvmTestUtils
  ...
  public void bytesNTest()
    ...
    byte[] triggerData = WvmTestUtils.parseAbi("testbytesN()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void divZeroTest()
    ...
    byte[] triggerData = WvmTestUtils.parseAbi("testDivZero()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void shiftByNegativeTest()
    ...
    byte[] triggerData = WvmTestUtils.parseAbi("testShiftByNegative()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void enumTypeTest()
    ...
    byte[] triggerData = WvmTestUtils.parseAbi("testEnumType()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void functionPointerTest()
    ...
    byte[] triggerData = WvmTestUtils.parseAbi("testFunctionPointer()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void assertTest()
    ...
    byte[] triggerData = WvmTestUtils.parseAbi("testAssert()", null);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void systemPrecompileTest()
    ...
    byte[] triggerData = WvmTestUtils.parseAbi("voteForSingleWitness(address,uint256)", params);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
  ...
  public void outOfMemTest()
    ...
    byte[] triggerData = WvmTestUtils.parseAbi("testMem(uint256)", params);
    result = WvmTestUtils
        .triggerContractAndReturnWvmTestResult(Hex.decode(OWNER_ADDRESS), contractAddress,
            triggerData, 0, feeLimit, dbManager, null);
