...
public class InternalTransactionComplexTest {
   ...
   *
   * // this is to test wither the WVM is returning vars from one contract calling another //
  ...
  public void internalTransactionAsInstanceTest()
    ...
    /* =================================== CALL makeTheCall =================================== */
    byte[] triggerData1 = WvmTestUtils.parseAbi("makeTheCall()", "");
    ...
    byte[] triggerData2 = WvmTestUtils.parseAbi("testCallbackReturns_()", "");
    runtime = WvmTestUtils
        .triggerContractWholeProcessReturnContractAddress(Hex.decode(OWNER_ADDRESS),
