...
public class AssetIssueActuatorTest {
  ...
  private static final String NAME = "wyz-my";
  private static final long TOTAL_SUPPLY = 10000L;
  private static final int WYZ_NUM = 10000;
  ...
  private Any getContract() {
    ...
    return Any.pack(
        AssetIssueContract.newBuilder()
            ...
            .setName(ByteString.copyFromUtf8(NAME)).setTotalSupply(TOTAL_SUPPLY).setWyzNum(WYZ_NUM)
            .setNum(NUM)
  ...
  public void SameTokenNameCloseAssetIssueSuccess() {
    ...
    try {
      ...
      Assert.assertEquals(WYZ_NUM, assetIssueCapsule.getWyzNum());
      ...
      Assert.assertEquals(WYZ_NUM, assetIssueCapsuleV2.getWyzNum());
  ...
  public void zeroTotalSupplyTest() {
    ...
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8(NAME)).setTotalSupply(0).setWyzNum(WYZ_NUM).setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
  ...
  @Test
  /*
   * Wyz num must greater than zero.Else can't asset issue and balance do not
   * change.
   */
  public void negativeWyzNumTest() {
    long nowTime = new Date().getTime();
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
    ...
    try {
      ...
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertTrue("WyzNum must greater than 0!".equals(e.getMessage()));
      AccountCapsule owner = dbManager.getAccountStore()
          .get(ByteArray.fromHexString(OWNER_ADDRESS));
      AssetIssueCapsule assetIssueCapsule = dbManager.getAssetIssueStore()
          .get(ByteArray.fromString(NAME));
   ...
   * change.
   */
  public void zeroWyzNumTest() {
    long nowTime = new Date().getTime();
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8(NAME)).setTotalSupply(TOTAL_SUPPLY).setWyzNum(0)
            .setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
  ...
  public void assetNameTest() {
    ...
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.EMPTY).setTotalSupply(TOTAL_SUPPLY).setWyzNum(WYZ_NUM).setNum(NUM)
    ...
    contract = Any.pack(
        AssetIssueContract.newBuilder()
            ...
            .setWyzNum(WYZ_NUM).setNum(NUM).setStartTime(nowTime)
            .setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
    ...
    contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8("t e")).setTotalSupply(TOTAL_SUPPLY).setWyzNum(WYZ_NUM)
            .setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
    ...
    contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8("0")).setTotalSupply(TOTAL_SUPPLY).setWyzNum(WYZ_NUM)
            .setNum(NUM)
            .setStartTime(nowTime).setEndTime(nowTime + 24 * 3600 * 1000)
            .setDescription(ByteString.copyFromUtf8(DESCRIPTION))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
  ...
  @Test
  public void assetIssueWYZNameTest() {
    dbManager.getDynamicPropertiesStore().saveAllowSameTokenName(1);
    Any contract = Any.pack(
        AssetIssueContract.newBuilder()
            .setOwnerAddress(ByteString.copyFrom(ByteArray.fromHexString(OWNER_ADDRESS)))
            .setName(ByteString.copyFromUtf8("WYZ")).setTotalSupply(TOTAL_SUPPLY).setWyzNum(WYZ_NUM)
            .setNum(NUM)
            .setStartTime(startTime).setEndTime(endTime)
            .setDescription(ByteString.copyFromUtf8("description"))
            .setUrl(ByteString.copyFromUtf8(URL)).build());
    ...
    try {
      ...
      Assert.assertTrue(e instanceof ContractValidateException);
      Assert.assertEquals("assetName can't be wyz", e.getMessage());
    } catch (ContractExeException e) {
      Assert.assertFalse(e instanceof ContractExeException);
    } finally {
      dbManager.getAssetIssueStore().delete(ByteArray.fromString(NAME));
  ...
  public void IssueSameTokenNameAssert() {
    ...
    AssetIssueContract assetIssueContract = AssetIssueContract.newBuilder()
        ...
        .setTotalSupply(TOTAL_SUPPLY)
        .setWyzNum(WYZ_NUM).setNum(NUM).setStartTime(1).setEndTime(100).setVoteScore(2)
