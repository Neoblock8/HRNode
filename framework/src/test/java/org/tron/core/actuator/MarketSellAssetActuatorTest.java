...
public class MarketSellAssetActuatorTest {
  ...
  private static final String WYZ = "_";
  ...
  /**
   * no Enough Balance For Selling WYZ, result is failed, exception is "No enough balance !".
   */
  @Test
  public void noEnoughBalanceForSellingWYZ() {
  ...
  /**
   * no buy orders before,add first sell order,selling WYZ and buying token
   */
  @Test
  ...
  /**
   * no buy orders before,add first sell order,selling Token and buying WYZ
   */
  @Test
