...
public class TransferAssetActuatorTest {
  ...
  private static final String ASSET_NAME = "wyz";
  ...
  private static final String ownerASSET_NAME = "wyztest";
  ...
  /**
   * transfer assert to smartcontract addresss after WvmSolidity059
   */
  @Test
  public void transferToContractAddress()
    ...
    VMConfig.initAllowWvmTransferTrc10(1);
    VMConfig.initAllowWvmConstantinople(1);
    VMConfig.initAllowWvmSolidity059(1);
