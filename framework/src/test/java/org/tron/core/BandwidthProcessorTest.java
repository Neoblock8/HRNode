...
public class BandwidthProcessorTest {
  ...
  private static final int WYZ_NUM = 2;
  private static final int NUM = 2147483647;
  private static final int VOTE_SCORE = 2;
  private static final String DESCRIPTION = "WYZ";
  ...
  public void testCreateNewAccount() throws Exception {
    ...
    TransactionCapsule wyz = new TransactionCapsule(transferAssetContract);
    ...
    long bytes = wyz.getSerializedSize();
  ...
  public void testFree() throws Exception {
    ...
    TransactionCapsule wyz = new TransactionCapsule(contract);
    ...
    TransactionTrace trace = new TransactionTrace(wyz, StoreFactory
        .getInstance(), new RuntimeImpl());
    dbManager.consumeBandwidth(wyz, trace);

    AccountCapsule ownerCapsuleNew = chainBaseManager.getAccountStore()
        .get(ByteArray.fromHexString(OWNER_ADDRESS));

    Assert.assertEquals(122L + (dbManager.getDynamicPropertiesStore().supporwvm()
    ...
    Assert.assertEquals(
        122L + (chainBaseManager.getDynamicPropertiesStore().supporwvm()
            ? Constant.MAX_RESULT_SIZE_IN_TX : 0),
    ...
    Assert.assertEquals(61L + 122
            + (chainBaseManager.getDynamicPropertiesStore().supporwvm()
  ...
  public void testConsumeAssetAccountV2() throws Exception {
    ...
    Assert.assertEquals(
        113L + (chainBaseManager.getDynamicPropertiesStore().supporwvm()
            ? Constant.MAX_RESULT_SIZE_IN_TX : 0),
  ...
  public void sameTokenNameCloseConsumeSuccess() {
    ...
    long byteSize = wyz.getInstance().toBuilder().clearRet().build().getSerializedSize()
        + Constant.MAX_RESULT_SIZE_IN_TX;
  ...
  public void sameTokenNameCloseTransferToAccountNotExist() {
    ...
    TransactionCapsule wyz = new TransactionCapsule(contract, chainBaseManager.getAccountStore());
    TransactionTrace trace = new TransactionTrace(wyz, StoreFactory
        .getInstance(), new RuntimeImpl());
