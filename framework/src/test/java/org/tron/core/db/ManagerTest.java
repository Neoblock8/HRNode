...
public class ManagerTest extends BlockGenerate {
  ...
  public void setBlockReference()
    ...
    TransferContract tc =
        TransferContract.newBuilder()
            ...
            .build();
    TransactionCapsule wyz = new TransactionCapsule(tc, ContractType.TransferContract);
    if (chainManager.getDynamicPropertiesStore().getLatestBlockHeaderNumber() == 0) {
      ...
      chainManager.setBlockReference(wyz);
      Assert.assertEquals(1,
          ByteArray.toInt(wyz.getInstance().getRawData().getRefBlockBytes().toByteArray()));
    }
  ...
  public void pushBlockInvalidMerkelRoot() {
    Transaction wyz = Transaction.newBuilder().build();
    TransactionCapsule moreTrans = new TransactionCapsule(wyz);
  ...
  public void pushBlockTooMuchShieldedTransactions() {
    ShieldContract.ShieldedTransferContract wyz1 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(10)
        .setToAmount(10)
        .build();
    ShieldContract.ShieldedTransferContract wyz2 = ShieldContract.ShieldedTransferContract
        .newBuilder()
        .setFromAmount(20)
        .setToAmount(20)
        .build();
    TransactionCapsule trans1 = new TransactionCapsule(wyz1, ContractType.ShieldedTransferContract);
    TransactionCapsule trans2 = new TransactionCapsule(wyz2, ContractType.ShieldedTransferContract);
