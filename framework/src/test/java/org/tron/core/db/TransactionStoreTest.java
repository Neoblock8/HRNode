...
public class TransactionStoreTest {
  ...
  public void getTransactionTest() throws BadItemException, ItemNotFoundException {
    ...
    final TransactionStore wyzStore = chainBaseManager.getTransactionStore();
    ...
    wyz.setBlockNum(blockCapsule.getNum());
    blockStore.put(blockCapsule.getBlockId().getBytes(), blockCapsule);
    wyzStore.put(wyz.getTransactionId().getBytes(), wyz);
    Assert.assertEquals("Get transaction is error",
        wyzStore.get(wyz.getTransactionId().getBytes()).getInstance(), wyz.getInstance());
    ...
    tc =
        TransferContract.newBuilder()
            ...
            .setToAddress(ByteString.copyFromUtf8("bbb"))
            .build();
    wyz = new TransactionCapsule(tc, ContractType.TransferContract);
    Assert.assertNull(wyzStore.get(wyz.getTransactionId().getBytes()));
  ...
  public void getUncheckedTransactionTest() {
    ...
    wyzStore.put(wyz.getTransactionId().getBytes(), wyz);
    Assert.assertEquals("Get transaction is error",
        wyzStore.getUnchecked(wyz.getTransactionId().getBytes()).getInstance(), wyz.getInstance());
    ...
    tc =
        TransferContract.newBuilder()
            ...
            .build();
    wyz = new TransactionCapsule(tc, ContractType.TransferContract);
    Assert.assertNull(wyzStore.getUnchecked(wyz.getTransactionId().getBytes()));
