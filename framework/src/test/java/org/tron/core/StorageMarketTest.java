...
public class StorageMarketTest {
  ...
  public void testBuyStorage() {
    ...
    long quant = 2_000_000_000_000L; // 2 million wyz
  ...
  public void testBuyStorage2() {
    ...
    long quant = 1_000_000_000_000L; // 1 million wyz
  ...
  public void testBuyStorageBytes() {
    ...
    long bytes = 2694881440L; // 2 million wyz
  ...
  public void testSellStorage2() {
    ...
    long bytes1 = 2694881440L - 1360781717L; // 1 million wyz
    long bytes2 = 1360781717L; // 1 million wyz
