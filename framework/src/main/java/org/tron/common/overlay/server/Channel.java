...
public class Channel {
  ...
  @Autowired
  private HRNetworkNetHandler HRNetworkNetHandler;
  @Autowired
  ...
  public void init(ChannelPipeline pipeline, String remoteId, boolean discoveryMode,
    ...
    pipeline.addLast("lengthDecode", new WyzProtobufVarint32FrameDecoder(this));
    ...
    HRNetworkNetHandler.setChannel(this);
    pbftHandler.setChannel(this);

    p2pHandler.setMsgQueue(msgQueue);
    HRNetworkNetHandler.setMsgQueue(msgQueue);
  ...
  public void publicHandshakeFinished(ChannelHandlerContext ctx, HelloMessage msg) {
    ...
    ctx.pipeline().addLast("data", HRNetworkNetHandler);
