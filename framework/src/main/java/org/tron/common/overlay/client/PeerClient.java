...
public class PeerClient {
  ...
  private ChannelFuture connectAsync(String host, int port, String remoteId,
    ...
    HRNetworkChannelInitializer HRNetworkChannelInitializer = ctx
        .getBean(HRNetworkChannelInitializer.class, remoteId);
    HRNetworkChannelInitializer.setPeerDiscoveryMode(discoveryMode);
    ...
    b.handler(HRNetworkChannelInitializer);
