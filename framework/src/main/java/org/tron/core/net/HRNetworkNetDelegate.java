...
public class HRNetworkNetDelegate {
  ...
  public boolean contain(Sha256Hash hash, MessageTypes type) {
    ...
    } else if (type.equals(MessageTypes.WYZ)) {
  ...
  public void pushTransaction(TransactionCapsule wyz) throws P2pException {
    try {
      ...
      throw new P2pException(TypeEnum.BAD_WYZ, e);
      ...
      throw new P2pException(TypeEnum.WYZ_EXE_FAILED, e);
    }
  }
